              ...
              <>
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-muted-foreground">
                    Fill in your details & unlock your future 🚀
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      className="pl-12 h-12 bg-muted/30 border-border/50 focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-xl transition-all"
                      required
                    />
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    >
                      <SelectTrigger className="pl-12 h-12 bg-muted/30 border-border/50 focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-xl">
                  ...
                  <Button
                    ...
                    className="w-full h-12 text-lg font-semibold bg-gradient-to-r from-primary via-secondary to-accent hover:shadow-glow-lg transition-all duration-300 rounded-xl relative overflow-hidden group"
                  >
